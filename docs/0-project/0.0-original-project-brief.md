...
> **Note:** This is the original unedited brainstorm from 2026-02-28. Moved from `plan.md` at the workspace root.
> For the organized vision document, see [0.1-vision-and-roadmap.md](0.1-vision-and-roadmap.md).
