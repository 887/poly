...
overview-page-agents-subtitle = Fonctions agentiques actives sur vos serveurs.
overview-page-agents-empty = Aucun agent actif pour le moment. Le SDK Agent arrive bientôt.
