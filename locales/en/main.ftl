...
settings-mcp-transport-label = MCP transport
settings-mcp-transport-desc = How AI clients connect to Poly's MCP server. SSE is the broadest-compatibility option; see
...
voice-video-toggle-camera = Toggle Camera
voice-video-toggle-screen = Toggle Screen Share
...
new-conversation-description = Choose one friend to start a direct conversation.
...
friends-add-placeholder = User name or id (e.g. Iris)
...
agent-section-features = Features
...
agent-panel-disabled-state = Agent is off for this chat. Turn it on with the toggle above to use memory, drafts, and writing style.
...
overview-page-stats-subtitle = A snapshot of your servers, messages, and unread.
