...
chat-settings-catch-up = Catch me up
chat-settings-catch-up-desc = Copy the last 20 messages of this conversation as a summary prompt — paste into Claude Desktop or any chat AI to get a quick recap.
chat-settings-catch-up-button = Copy last 20 messages
chat-settings-catch-up-copied = Copied to clipboard ✓
