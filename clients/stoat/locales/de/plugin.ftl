...
plugin-stoat-signup-title = Stoat-Konto hinzufügen
plugin-stoat-signup-description = Gib deine Stoat-Server-URL und Kontodaten ein, um dich anzumelden.
plugin-stoat-signup-back = ← Backend auswählen
plugin-stoat-signup-url-label = Server-URL
plugin-stoat-signup-url-placeholder = https://api.stoat.chat
plugin-stoat-signup-email-label = E-Mail-Adresse
plugin-stoat-signup-email-placeholder = alice@example.com
plugin-stoat-signup-password-label = Passwort
plugin-stoat-signup-password-placeholder = Passwort eingeben
...
# Account overview
plugin-stoat-overview-title = Deine Server
plugin-stoat-overview-subtitle = Alle Server dieses Stoat-Kontos
