...
impl Guest for MatrixPlugin {
    ...
    // G.5 — voice-transport WIT stubs. Matrix voice/video flows through
    // separate widget / Element Call surfaces; the plain messenger plugin
    // returns the documented `VoiceTransportBackend` defaults here.
