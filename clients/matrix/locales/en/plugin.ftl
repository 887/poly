# Matrix client plugin — English translations
# All keys MUST be prefixed with "plugin-matrix-"

plugin-matrix-title = Matrix
plugin-matrix-description = Connect to any Matrix homeserver. Supports federation, Spaces, and end-to-end encryption.
plugin-matrix-settings-description = Matrix accounts are configured through the Add Account flow. Use the plugin toggle in Settings → Plugins to enable or disable Matrix in this build.

plugin-matrix-signup-name = Matrix
plugin-matrix-signup-desc = Connect to a Matrix homeserver with username and password.
plugin-matrix-signup-title = Add Matrix Account
plugin-matrix-signup-description = Enter your homeserver URL and account credentials to sign in.
plugin-matrix-signup-back = ← Choose Backend
plugin-matrix-signup-url-label = Homeserver URL
plugin-matrix-signup-url-placeholder = https://matrix.org
plugin-matrix-signup-username-label = Username
plugin-matrix-signup-username-placeholder = @alice:matrix.org
plugin-matrix-signup-password-label = Password
