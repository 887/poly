# Demo Plugin — French translations
# Toutes les clés DOIVENT être préfixées par "plugin-demo-"

# --- Nom d'affichage & en-tête de section ---
plugin-demo-title = Paramètres démo
plugin-demo-section-heading = Backend démo

# --- Description de la page de paramètres ---
plugin-demo-description = Configurer le client de données de démonstration intégré. Activez le mode démo pour charger ou effacer des comptes, serveurs et conversations exemples.
